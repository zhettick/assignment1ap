...
```
![createOrderS.png](postman/createOrderS.png)
...
```
![createOrderF.png](postman/createOrderF.png)

### Get Order
`GET http://localhost:8080/orders/{id}`
![getOrder.png](postman/getOrder.png)

### Cancel Order
`PATCH http://localhost:8080/orders/{id}/cancel`
![cancelOrderF.png](postman/cancelOrderF.png)
...
```
![createPayment.png](postman/createPayment.png)

### Get Payment
`GET http://localhost:8081/payments/{id}`
![getPayment.png](postman/getPayment.png)
---
